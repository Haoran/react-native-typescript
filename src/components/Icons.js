...
export const Icons = (props) => {
    ...
    return (React.createElement(View, { style: {
        ...
        React.createElement(Image, { source: iconUrl[iconName], style: {
                width: adapt.pxToDp(width ? width : 30),
                height: adapt.pxToDp(height ? height : 30),
            } })
        :
            uri ?
                React.createElement(Image, { source: { uri: uri }, style: {
                        width: adapt.pxToDp(width ? width : 30),
                        height: adapt.pxToDp(height ? height : 30),
                    } })
                :
                    React.createElement(Image, { source: iconUrl["loading"], style: {
                            width: adapt.pxToDp(width ? width : 30),
                            height: adapt.pxToDp(height ? height : 30),
                        } })));
};
