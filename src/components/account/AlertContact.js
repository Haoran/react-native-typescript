...
let Modify = class Modify extends Component {
    ...
    render() {
        ...
        return (React.createElement(View, { style: styles.container },
            ...
            React.createElement(List, null, contactList.map(item => {
                return (React.createElement(Item, { arrow: "horizontal", key: item.id, onClick: () => this.props.navigation.navigate('OperateContact', {
                        regionId: regionId,
                        puid: puid,
                        name: item.note,
                        item: item,
            ...
            React.createElement(List, null,
                React.createElement(Item, { arrow: "horizontal", onClick: () => this.props.navigation.navigate('OperateContact', {
                        regionId: regionId,
                        puid: puid,
                        name: 'Add Contact'
                    }) }, "Add New..."))));
...
Modify.navigationOptions = ({ navigation }) => ({
    ...
    headerRight: (React.createElement(TouchableOpacity, { onPress: () => navigation.navigate('OperateContact', {
...
//# sourceMappingURL=AlertContact.js.map