...
export default class HashrateCharts extends Component<any, any> {
    ...
    render() {
        ...
        const option = {
            ...
            xAxis: {
                ...
                data: shareHistory.tickers ? shareHistory.tickers.map(
                    t => dimension == "1h" ? moment.unix(t[0]).format('hh:ss') : moment.unix(t[0]).format('MM/DD')) : [],
                axisLabel: {
                    textStyle: {
        ...
        return (
            <Echarts width={adapt.screenW() - 10} height={adapt.screenW() - 180 <= 170 ? 170 : adapt.screenW() - 180}
                     style={styles.chart} option={option}/>
        );
